...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private cdc.public$.customers.Value before;
  private cdc.public$.customers.Value after;
   ...
   */
  public Envelope(cdc.public$.customers.Value before, cdc.public$.customers.Value after, io.debezium.connector.postgresql.Source source, java.lang.CharSequence op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (cdc.public$.customers.Value)value$; break;
    case 1: after = (cdc.public$.customers.Value)value$; break;
   ...
   */
  public cdc.public$.customers.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(cdc.public$.customers.Value value) {
    this.before = value;
  }
   ...
   */
  public cdc.public$.customers.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(cdc.public$.customers.Value value) {
    this.after = value;
  }
   ...
   */
  public static cdc.public$.customers.Envelope.Builder newBuilder() {
    return new cdc.public$.customers.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static cdc.public$.customers.Envelope.Builder newBuilder(cdc.public$.customers.Envelope.Builder other) {
    if (other == null) {
      return new cdc.public$.customers.Envelope.Builder();
    } else {
      return new cdc.public$.customers.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static cdc.public$.customers.Envelope.Builder newBuilder(cdc.public$.customers.Envelope other) {
    if (other == null) {
      return new cdc.public$.customers.Envelope.Builder();
    } else {
      return new cdc.public$.customers.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private cdc.public$.customers.Value before;
    private cdc.public$.customers.Value.Builder beforeBuilder;
    private cdc.public$.customers.Value after;
    private cdc.public$.customers.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cdc.public$.customers.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = cdc.public$.customers.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = cdc.public$.customers.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cdc.public$.customers.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder setBefore(cdc.public$.customers.Value value) {
     ...
     * @return This builder.
     */
    public cdc.public$.customers.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(cdc.public$.customers.Value.newBuilder(before));
        } else {
          setBeforeBuilder(cdc.public$.customers.Value.newBuilder());
        }
      }
    ...
    public cdc.public$.customers.Envelope.Builder setBeforeBuilder(cdc.public$.customers.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder setAfter(cdc.public$.customers.Value value) {
     ...
     * @return This builder.
     */
    public cdc.public$.customers.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(cdc.public$.customers.Value.newBuilder(after));
        } else {
          setAfterBuilder(cdc.public$.customers.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public cdc.public$.customers.Envelope.Builder setAfterBuilder(cdc.public$.customers.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public cdc.public$.customers.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder setOp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder setTransaction(event.block value) {
    ...
    public cdc.public$.customers.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public cdc.public$.customers.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (cdc.public$.customers.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (cdc.public$.customers.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new cdc.public$.customers.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new cdc.public$.customers.Value();
        }
